...
At low effort, giving an AI agent read-only database access answered 311 of 498 questions correctly (62.4%). A [generated table summaries](https://pypi.org/project/db-snooper/)—table of contents, selected profile slices, and pre-generated [schema links](https://pypi.org/project/schema-linker/)—answered 306 of 498 questions correctly (61.4%).

| Metric | Raw database access | Bundled table summary | Change |
|---|---:|---:|---:|
| Correct answers (of 498) | 311 (62.4%) | 306 (61.4%) | <span class="metric-neutral">−1.0 pp</span> |
...
|---|---:|---:|---:|
| Correct answers (of 498) | 287 (57.6%) | <span class="metric-neutral">303 (60.8%)</span> | 311 (62.4%) |
...
|---|---:|---:|---:|
| Correct answers (of 498) | 306 (61.4%) | 307 (61.6%) | <span class="metric-neutral">+0.2 pp</span> |
